...
const Dashboard = () => {
  ...
  const menuItemsByRole = {
    admin: [
      { to: "profile", icon: UserCircle, label: "Manage Profile" },
    ...
    <div className="drawer lg:drawer-open ">
      ...
      <div className="drawer-content flex flex-col">
        ...
        <main className="container  mx-auto px-4 py-6">
          ...
          <div className="rounded-xl border border-base-300 p-4 md:p-6 bg-base-200 shadow-sm">
      ...
      <div className="drawer-side ">
        ...
        <aside className="w-72 bg-base-200 border-r border-base-300 shadow-lg min-h-screen flex flex-col justify-between">
          <div>
          <div className="p-4 mb-4 text-center border-b border-base-300">
          ...
          <footer className="text-center text-xs text-gray-500 p-4 border-t border-base-300">
